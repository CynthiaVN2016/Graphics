...
Vector.refractThrough = function(a, normal) {
    var r = 1/1.5;
    var w = -1 * Vector.dotProduct(a, normal) * r;
    var k = Math.sqrt(1 + (w - r) * (w + r));
    return Vector.add( Vector.scale(a, r), Vector.scale(normal, w-k) );
};
